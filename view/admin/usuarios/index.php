        ...
        <div class="card horizontal admin">
            <div class="card-stacked">
                ...
                <div class="card-action">
                    <a href="<?php echo $_SESSION['home']."admin/usuarios/crear" ?>" title="Engadir novo usuario">
            ...
            <div class="card horizontal  sticky-action admin">
                <div class="card-stacked">
                    <div class="card-content">
                        ...
                        <strong>Novas: </strong><?php echo ($row->novas) ? "Sí" : "No" ?>
                    </div>
                    <div class="card-action">
                ...
                <div class="card-reveal">
                    ...
                    <p>
                        ¿Estás seguro de que queres borrar ao usuario<strong><?php echo $row->usuario ?></strong>?<br>
