    ...
    <form class="col m12 l6" method="POST" action="<?php echo $_SESSION['home'] ?>admin/usuarios/editar/<?php echo $id ?>">
        <div class="row">
            ...
            <p class="<?php echo $clase ?>">
                <label for="cambiar_contrasinal">
                    <input id="cambiar_contrasinal" name="cambiar_contrasinal" type="checkbox">
                    <span>Pulsa para cambiar o contrasinal</span>
                </label>
            </p>
        </div>
        <div class="row">
            ...
            <p>
                <label for="novas">
                    <input id="novas" name="novas" type="checkbox" <?php echo ($datos->novas == 1) ? "checked" : "" ?>>
                    <span>Novas</span>
                </label>
            </p>
            <p>
            ...
            <p class="<?php echo $clase ?>">
                ...
                Último acceso: <strong><?php echo $datos->data_acceso ? date("d/m/Y H:i", strtotime($datos->data_acceso)) : "Nunca"; ?></strong>
            ...
            <div class="input-field col s12">
                ...
                <button class="btn waves-effect waves-light" type="submit" name="gardar">Gardar
